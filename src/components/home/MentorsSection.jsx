      ...
      <div className="container px-4 lg:px-20 ">
        <div className="flex flex-col justify-center items-center gap-4">
          <div className="flex justify-center items-center py-20">
            <div>
              <p className="text-5xl font-semibold text-center text-[#992FFF] py-4">
                Mentors
              </p>
              <p className="text-xl">
          ...
          <section className="flex flex-col justify-center items-center w-full gap-8">
            <div className="flex justify-between items-center w-full gap-16">
              <div className="w-2/3">
                <ul className="text-white list-disc text-2xl space-y-4">
                  <li>
                    Been trading in the Indian and Forex Market for <span className="text-[#992FFF]">5+years.</span>
                  </li>
                  <li>Trained & Mentored more than <span className="text-[#992FFF]">700+</span> students.  </li>
                  <li>NSE certified Options & Equity Derivatives Trader.  </li>
                  <li>Successfully Handling portfolio worth <span className="text-[#992FFF]">$70000.</span>  </li>
                  <li>
                    Focussed on creating a diverse educational platform enabling
                    traders from all
                  </li>
